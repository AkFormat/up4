...
typedef bit<16> far_info_id_t; // FAR
typedef bit<16> pdr_id_t; // PDR
typedef bit<16> far_id_t; // FAR
typedef bit<16> qer_id_t; // QER
typedef bit<16> bar_id_t; // BAR
typedef bit<16> qfi_t; // QFI
