...
struct parsed_headers_t {
    ...
    ethernet_t ethernet;
    ipv4_t outer_ipv4;
    //ipv4_option_t outer_ipv4_option;
    udp_t outer_udp;
    gtpu_t gtpu;
    gtpu_options_t gtpu_options;
    gtpu_ext_psc_t gtpu_ext_psc;
    ipv4_t ipv4; // 普通ipv4包，如果没有gtp报头
    udp_t udp;   
    tcp_t tcp;
    icmp_t icmp; 
...
struct local_metadata_t {
    ...
    bit<16> checksum_gtp_ipv4_tmp;
    bit<16> checksum_gtp_udp_tmp;
    ...
    bool checksum_err_gtp_ipv4_igprs;
}
